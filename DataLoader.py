...
class DataLoader:
    ...
    def __normalize_data(self):
        # self.train_data.interpolate(method='values', limit_direction='forward')
        # self.train_data.interpolate(method='values', limit_direction='forward')
        self.test_data = self.test_data.interpolate()
        self.train_data = self.train_data.interpolate()

        cat_columns = self.__get_columns_by_type(numpy.object)
    ...
    def __get_columns_by_type(self, type):
